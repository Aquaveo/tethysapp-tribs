...
class ScenarioUploadWorkflow(object):
    """
    ...
    def prepare(self):
        ...
        # upload_scenario_job
        upload_executable = "upload_scenario_exe.py"
        upload_scenario_job = CondorWorkflowJobNode(
            name="upload_scenario",
            workflow=self.workflow,
            condorpy_template_name="vanilla_transfer_files",
            remote_input_files=(
                str(self.job_executables_dir / upload_executable),
        ...
        update_status_job = CondorWorkflowJobNode(
            ...
            condorpy_template_name="vanilla_transfer_files",
            remote_input_files=(
                str(self.job_executables_dir / status_executable),
                self.input_archive_path,
            ),
            attributes=dict(
    ...
    def run_job(self):
        ...
        try:
            ...
            resource = resource_db_session.query(Scenario).get(self.resource_id)

            resource.set_status(Scenario.ROOT_STATUS_KEY, Scenario.STATUS_PENDING)
