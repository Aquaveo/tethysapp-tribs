...
class TribsScenarioRealizationsTab(ResourceListTab):
    ...
    def get_href_for_resource(self, app_namespace, resource):
        ...
        """
        return reverse(f'{app_namespace}:tribs_realization_details_tab', args=[resource.id, 'summary'])
